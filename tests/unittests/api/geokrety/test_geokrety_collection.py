...
class TestGeokretyCollection(BaseTestCase):
    ...
    @request_context
    def test_geokret_collection_has_tracking_code_when_user_has_touched(self, move_type, expected):
    ...
    @request_context
    def test_geokret_collection_filter_by_tracking_code_as(self, username, expected):
    ...
    @request_context
    def test_geokret_collection_filter_by_tracking_code_user_has_touched(self, move_type, expected):
