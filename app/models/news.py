...
class News(db.Model):
    ...
    title = db.Column('tytul', db.String(50), key='title')
    content = db.Column('tresc', db.Text, key='content')
    ...
    last_comment_date_time = db.Column('ostatni_komentarz', db.DateTime, key='last_comment_date_time')
