...
class News(db.Model):
    ...
    username = db.Column('who', db.String(20), key='username')
    ...
    last_comment_date_time = db.Column('ostatni_komentarz', db.DateTime, key='last_comment_date_time', default="0000-00-00 00:00:00")
    created_on_date_time = db.Column('date', db.DateTime, key='created_on_date_time', default=datetime.datetime.utcnow)
